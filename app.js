...
const submitAttendance_1 = __importDefault(require("./routes/attendance/submitAttendance"));
...
const fileStorage = multer_1.default.diskStorage({
    ...
    filename: (_req, file, cb) => cb(null, new Date().toISOString() + '-' + file.originalname),
});
...
app.use('/submit-attendance', submitAttendance_1.default);
