...
const updateAttendance = async (t, BASE_URL, r, m) => await Attendance_1.default.updateOne({ token: t }, { fall2021MeetingsAttended: m + 1 }).catch((e) => redirection_1.default(r, DATABASE_ERROR_URL(BASE_URL), e));
exports.default = {
    authenticateToken,
    updateAttendance,
};
